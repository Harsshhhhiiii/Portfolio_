  ...
  return (
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <p style={{ color: "white" }}>
          Here are a few projects I've worked on recently. Please note that some projects Database might have their Cluster paused due to free tier limitations of MongoDB Atlas and Render. You can still view the code and the demo link for the projects.
        </p>
